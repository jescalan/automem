...
from automem.config import (ADMIN_TOKEN, API_TOKEN, AUTHORABLE_RELATIONS,
                            CLASSIFICATION_MODEL, COLLECTION_NAME,
                            ...
                            CONSOLIDATION_RUN_LABEL, CONSOLIDATION_TASK_FIELDS,
                            CONSOLIDATION_TICK_SECONDS,
                            DEFAULT_EXPAND_RELATIONS, EMBEDDING_MODEL,
                            ...
                            ENRICHMENT_SPACY_MODEL, FALKORDB_PORT,
                            FILTERABLE_RELATIONS, GRAPH_NAME,
                            JIT_ENRICHMENT_ENABLED, MEMORY_TYPES,
                            RECALL_EXPANSION_LIMIT, RECALL_RELATION_LIMIT,
                            RELATIONSHIP_TYPES, SEARCH_WEIGHT_CONFIDENCE,
                            SEARCH_WEIGHT_EXACT, SEARCH_WEIGHT_IMPORTANCE,
                            SEARCH_WEIGHT_KEYWORD, SEARCH_WEIGHT_RECENCY,
                            SEARCH_WEIGHT_TAG, SEARCH_WEIGHT_VECTOR,
                            SYNC_AUTO_REPAIR, SYNC_CHECK_INTERVAL_SECONDS,
                            TYPE_ALIASES, VECTOR_SIZE, normalize_memory_type)
